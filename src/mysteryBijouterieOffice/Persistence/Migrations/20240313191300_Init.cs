        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ParentOperationClaimId = table.Column<int>(type: "integer", nullable: true),
                    Name = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasShippingScale = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    FirstScaleLowerLimit = table.Column<decimal>(type: "numeric", nullable: true),
                    FirstScaleUpperLimit = table.Column<decimal>(type: "numeric", nullable: true),
                    SecondScaleLowerLimit = table.Column<decimal>(type: "numeric", nullable: true),
                    SecondScaleUpperLimit = table.Column<decimal>(type: "numeric", nullable: true),
                    FirstScaleShippingFee = table.Column<decimal>(type: "numeric", nullable: true),
                    SecondScaleShippingFee = table.Column<decimal>(type: "numeric", nullable: true),
                    TransactionFee = table.Column<decimal>(type: "numeric", nullable: false),
                    HasTaxShippingCost = table.Column<bool>(type: "boolean", nullable: false),
                    HasTaxServiceFee = table.Column<bool>(type: "boolean", nullable: false),
                    HasTaxTransactionFee = table.Column<bool>(type: "boolean", nullable: false),
                    HasTaxCommissions = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    DeletedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountLowerLimit = table.Column<decimal>(type: "numeric", nullable: false),
